...
-- RMS
    ...
    ('200019213', 'Iago Roque Ribeiro Novaes', 'LPA'),
    ('200016717', 'Harrison Borges dos Santos', 'POO'),
    ('200020478', 'Marcos Carvalho Pacheco', 'GDC');

-- LINKS
    INSERT INTO link (url, rm_id, subject_id) VALUES
    ('https://code.visualstudio.com/', '200019213', 'POO'),
    ('https://developer.mozilla.org/pt-BR/docs/Web/HTML', '200016717', 'POO'),
    ('https://drive.google.com/file/d/1-awzfHVWIjKI_L_9rgX1rQzUJUneCcgf/view?usp=drive_link', '200016717', 'POO'),
    ...
    ('https://docs.google.com/document/d/1U3dPasSmHI1CfxWZ6keETpJ_vSYd4tJp3O9Q3Td6RHg/edit?usp=sharing', '200020478', 'GDC'),
